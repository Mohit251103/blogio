    ...
    return (
        <div className="grow flex flex-col max-md:hidden">
            <div className="flex flex-col justify-center items-center w-full ms-3">
                {/* tag area */}
                {showTags && <div className="flex flex-col p-2 items-start w-full">
                ...
                {/* trending accounts */}
                {showContent && <div className="flex flex-col p-2 items-start w-full ms-3">
            ...
            { (!showContent || !showTags ) && <div className="grow flex justify-center items-center max-md:hidden">
